function FaseDois ()
{
	...
	var vida =  new Image ();
	vida.src = "Fase 2/coracao.png";
	
	var contadorVida = 3;
	
	
	var fundoVida = new Image();
	fundoVida.src = "Fase 2/base de vida.png";
	fundoVida_x = 666;
	fundoVida_y = 8;
	fundoVida_w = 140;
	fundoVida_h = 50;
	...
	var pergunta2 = new Image ();
	pergunta2.src = "Fase 2/Perguntas2/questao" + ordem + ".png";
	pergunta2_x = 230;
	pergunta2_y = 430;
	pergunta2_w = 445;
	pergunta2_h = 95;
	...
	respostaerrada1.src = "Fase 2/Respostas Erradas2/questao"+ ordem + " - alternativa Errada.png";
	var respostaerrada2 = new Image();	
	respostaerrada2.src = "Fase 2/Respostas Erradas2/questao"+ ordem + " - alternativa Errada2.png";

	var respostacerta = new Image ();
	respostacerta.src = "Fase 2/Respostas Certas2/questao"+ ordem + " - alternativa certa.png";
	respostaerrada1_a = 1;
	respostaerrada2_a = 1;
	respostacerta_a = 1;
	...
	this.draw = function()
	{
		...
		context.drawImage(pergunta2,pergunta2_x,pergunta2_y,pergunta2_w,pergunta2_h);
